 ...
 * Use the {@link WarFragment#newInstance} factory method to
...
public class WarFragment extends Fragment {
    ...
    public static WarFragment newInstance(String param1, String param2) {
        WarFragment fragment = new WarFragment();
