...
public class AdapterForTopCardGame extends RecyclerView.Adapter<AdapterForTopCardGame.MyViewHolder> {
    List<Game> allGames;
    Context context;

    public AdapterForTopCardGame(List<Game> allGames, Context context) {
