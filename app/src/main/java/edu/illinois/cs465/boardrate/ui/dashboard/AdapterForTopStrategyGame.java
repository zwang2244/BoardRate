...
public class AdapterForTopStrategyGame extends RecyclerView.Adapter<AdapterForTopStrategyGame.MyViewHolder> {
    List<Game> allGames;
    Context context;

    public AdapterForTopStrategyGame(List<Game> allGames, Context context) {
